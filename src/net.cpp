...
static const char *strDNSSeed[][2] = {
    {"zone1.ageofdestruction.com", "zone1.ageofdestruction.com"},
    {"zone2.ageofdestruction.com", "zone2.ageofdestruction.com"},
    {"zone3.ageofdestruction.com", "zone3.ageofdestruction.com"},
    {"zone4.ageofdestruction.com", "zone4.ageofdestruction.com"},
    {"zone5.ageofdestruction.com", "zone5.ageofdestruction.com"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("themark-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TheMark is probably already running."), addrBind.ToString().c_str());
        else

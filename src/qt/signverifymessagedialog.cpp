    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a TheMark address (e.g. CMRPxAsEZQfsnL5AxyCB4mDXixPJtkCBx2)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a TheMark address (e.g. CMRPxAsEZQfsnL5AxyCB4mDXixPJtkCBx2)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter TheMark signature"));
#endif

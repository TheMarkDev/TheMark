...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MARK");
    case mBTC: return QString("mMARK");
    case uBTC: return QString::fromUtf8("μMARK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TheMarks"));
    case mBTC: return QString(QObject::tr("Milli-TheMarks (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TheMarks (1 / 1,000,000)"));
    default: return QString("???");
    }
}

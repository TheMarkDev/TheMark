...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/themark/tx/%s|https://coinplorer.com/MARK/Transactions/%s|https://explorer.novaco.in/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/themark/tx/%s|https://coinplorer.com/MARK/Transactions/%s|https://explorer.novaco.in/tx/%s").toString();
